...
/* harmony export */   "generateToc_": () => (/* binding */ generateToc_),
/* harmony export */   "generateToc": () => (/* binding */ generateToc)
/* harmony export */ });
function generateToc_(selectorQuery) {
  // get toc
  var toc = document.querySelector(selectorQuery); // insert anchor into headers

  var innerHtmlEdited = document.documentElement.innerHTML.replace(/<h([\d])>([^<]+)<\/h([\d])>/gi, function (match, openLevel, titleText, closeLevel) {
    ...
    var anchoredHeader = "<h" + openLevel + "><a name=\"" + anchor + "\">" + titleText + "</a></h" + closeLevel + ">";
  ...
  function createTable(elem, data) {
    ...
    var link = "<li><a href=".concat("#" + linkName, ">").concat(text, "</a>");
    data += "ul" + link; // get next h elem 
  ...
  document.documentElement.innerHTML.replace(/<h([\d])>([^<]+)<\/h([\d])>/gi, function (match, openLevel, titleText, closeLevel) {
    if (openLevel != closeLevel) {
      return str;
    } // create <ul> elem and add link li for h elem 
